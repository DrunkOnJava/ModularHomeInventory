...
//  Dependencies: SwiftUI, Core, SharedUI, Items, BarcodeScanner
//  Testing: HomeInventoryModularTests/AppCoordinatorTests.swift
//
//  Description: Central coordinator managing app navigation, state, and module communication
//

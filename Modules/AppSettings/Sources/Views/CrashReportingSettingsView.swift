...
//  Testing: Modules/AppSettings/Tests/AppSettingsTests/CrashReportingSettingsViewTests.swift
//
//  Description: Comprehensive crash reporting configuration with privacy controls, detail level settings,
//  pending reports management, and test crash generation for debugging purposes
//

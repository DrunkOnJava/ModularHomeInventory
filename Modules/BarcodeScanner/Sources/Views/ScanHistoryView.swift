...
//  Testing: Modules/BarcodeScanner/Tests/ScannerTests/ScanHistoryViewTests.swift
//
//  Description: View displaying scan history with grouped entries and navigation
//               to associated items
//

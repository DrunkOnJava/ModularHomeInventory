...
//
//  Description: Main implementation of the Scanner module providing factory methods
//               for creating barcode scanning views and managing scanner dependencies
//
...
//  Testing: Modules/BarcodeScanner/Tests/ScannerTests/ScannerModuleTests.swift
//
//  Description: Main implementation of the BarcodeScanner module providing barcode and document
//  scanning capabilities. This module manages scanner dependencies, creates scanner views, and
//  orchestrates the scanning workflow including offline queue management and sound feedback.
//
//  Created by Griffin Long on June 25, 2025
//  Copyright © 2025 Home Inventory. All rights reserved.
//

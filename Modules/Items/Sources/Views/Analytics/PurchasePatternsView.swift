...
//  Testing: ItemsTests/Analytics/PurchasePatternsViewTests.swift
//
//  Description: Advanced purchase pattern analysis view providing insights into recurring purchases,
//  seasonal patterns, brand loyalty, price preferences, and shopping habits with detailed pattern
//  breakdowns and actionable recommendations for optimizing buying behavior.
//

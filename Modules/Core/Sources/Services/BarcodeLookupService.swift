...
//  Testing: Modules/Core/Tests/CoreTests/BarcodeLookupServiceTests.swift
//
//  Description: Service for looking up product information from barcodes using multiple free sources with fallback
//

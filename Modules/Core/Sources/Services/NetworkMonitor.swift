...
//  Module: Core
//  Dependencies: Foundation, Network, Combine
//  Testing: Modules/Core/Tests/CoreTests/NetworkMonitorTests.swift
//
//  Description: Network connectivity monitoring service for offline/online state management
//

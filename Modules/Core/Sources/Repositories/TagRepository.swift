...
//  Testing: Modules/Core/Tests/CoreTests/TagRepositoryTests.swift
//
//  Description: Repository protocol for managing tags with search capabilities, usage
//  tracking, and item association. Supports tag popularity metrics and flexible
//  tag operations for organizing inventory items.
//
